Global win = CreateWindow("Painting program - Floodfill Example",100,100,800,600,0,1) 
...
Function updateinterface()
	...
	End If
	Text 320,480,"Press f to flood below mouse"
	Text 10,520,"Brush size : "+brushsize+" (key 1 to 9)
