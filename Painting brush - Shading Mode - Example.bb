Global win = CreateWindow("Painting brush - Shading Mode - Example",100,100,800,600,0,1) 
...
Repeat 
	...
	If we=$102;keyup
		...
		If EventData() = 31 ;'shade
			If shame=True Then shade = False Else shade = True
			updateinterface
		End If
...
Function updateinterface()
	...
	If shade = True
		Text 10,515,"Shade is on (s)"
	Else
		Text 10,515,"Shade is off (s)"
	End If
