Global win = CreateWindow("Painting Program - Mirror Draw - Example",100,100,800,600,0,1) 
...
Repeat 
	...
	If we=$102;keyup
		If screen = "canvas"
		If EventData()=23;i key mirror draw
